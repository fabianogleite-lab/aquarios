-- Migration 26: Corrige upsert_bot_persona — INSERT na tabela correta
-- Bug em migration 09: usava timeline_posts que não existe.
-- A tabela real usada pelo app (e pelo banco remoto) é community_posts.
...
BEGIN
  ...
  -- community_posts é a tabela real (timeline_posts não existe)
